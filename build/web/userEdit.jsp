...
<html>
    ...
    <div class="container">
        <section class="box">
            ...
            <div class="form1">
                <form id="editUserForm" name="userForm" method="post" action="${pageContext.request.contextPath}/user/update">
                    <div class="form2">
                        ...
                        <input type="text" id="completeAddress" name="completeAddress" class="form-control" 
                               value="<c:out value='${userDetails.completeAddress}'/>">

                        <label class="col-sm-0 col-form-label">Birthday</label>
                        <input type="date" id="birthday" name="birthday" class="form-control"
                               value="<c:out value='${userDetails.birthday}'/>">

                        <label class="col-sm-0 col-form-label">Cell Number</label>
                        <input type="text" id="cellNumber" name="cellNumber" class="form-control"
                               value="<c:out value='${userDetails.cellNumber}'/>">

                        <label class="col-sm-0 col-form-label">User Role</label>
                        <div class="input-group">
                            <select id="userRole" name="userRole" required class="form-control"
                                    value="<c:out value='${userDetails.userRole}'/>">
                                <option value="">--Select user Role--</option>
                                <option value="Customer" <c:if test="${userDetails.userRole == 'Customer'}">selected</c:if>>Customer</option>
                                <option value="Administrator" <c:if test="${userDetails.userRole == 'Administrator'}">selected</c:if>>Administrator </option>
