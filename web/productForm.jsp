        ...
        <div class="container">
            <section class="box">
                    ...
                    <div class="formTitle">Products Form</div>
                        ...
                        <div class="form1">
                            <form id="productForm" name="productForm" method="post" action="${pageContext.request.contextPath}/product/create">
                                <div class="form2">
                                ...
                                <input type="text" id="size" name="size" placeholder="0" class="form-control" required>
                                   
                                        
                                <label class="col-sm-0 col-form-label">Price</label>
                                <input type="text" id="price" name="price" placeholder="0.00" class="form-control" required>

                                
                                <label class="col-sm-0 col-form-label">Quantity</label>
                                <input type="text" id="quantity" name="quantity" placeholder="0" class="form-control" required>
